...
```cpp
// A simple packet1 stream class.  None of its members is virtual.
...
// A mock packet1 stream class.  It inherits from no other, but defines
...
One way to do it is to templatize your code that needs to use a packet1 stream.
More specifically, you will give your code a template type argument for the type
of the packet1 stream. In production, you will instantiate your template with
